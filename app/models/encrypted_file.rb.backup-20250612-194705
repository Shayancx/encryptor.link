class EncryptedFile < ApplicationRecord
  ...
  # Validation using actual column names - removed file_data validation
  ...
  def store_encrypted_data(base64_data)
    begin
      ...
      unless self.encrypted_blob.attached?
        raise StandardError, "Failed to attach encrypted file to Active Storage"
      end
